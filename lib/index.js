(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactSingleDropdown"] = factory();
	else
		root["ReactSingleDropdown"] = factory();
})(this, function() {
...
var ReactSingleDropdown = function (_React$Component) {
  _inherits(ReactSingleDropdown, _React$Component);

  function ReactSingleDropdown(props) {
    _classCallCheck(this, ReactSingleDropdown);

    var _this = _possibleConstructorReturn(this, (ReactSingleDropdown.__proto__ || Object.getPrototypeOf(ReactSingleDropdown)).call(this, props));
    ...
    _this.onOptionClick = function (option) {
      ...
      _this.props.onSelect ? _this.props.onSelect(option) : null;
    };
  ...
  _createClass(ReactSingleDropdown, [{
    key: 'render',
    value: function render() {
      ...
      var arrow = props.noAnimation ? 709 : state.isOptionsVisible ? 708 : 709;
      var options = props.options && Array.isArray(props.options) ? props.options : [];
      var defaultSelected = state.selectedOption ? state.selectedOption : props.defaultSelected && this.indexOf(props.options, props.defaultSelected) > -1 ? props.defaultSelected : null;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'li',
            { className: 'selected-option', 'data-value': state.selectedOption },
            defaultSelected ? defaultSelected : state.selectedOption,
            _react2.default.createElement(
              'span',
              { className: 'arrow' },
  ...
  return ReactSingleDropdown;
}(_react2.default.Component);

exports.default = ReactSingleDropdown;
...
// module
exports.push([module.i, ".selected-option-container{position:relative}.selected-option-container .selected-option{border:1px solid #1692e5;padding:5px 25px 5px 5px;background:#fff}.selected-option-container .selected-option .arrow{position:absolute;right:10px}.selected-option-container .options-container{position:absolute;background:#fff;z-index:10000;width:100%;border:1px solid #1692e5;border-top:none}.selected-option-container .options-container li{padding:5px}.selected-option-container .options-container li.selected,.selected-option-container .options-container li:hover{background:#09f;color:#fff}.options-container,.selected-option-container{margin:0;list-style:none;padding:0;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}.options-container li,.selected-option-container li{min-height:20px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}", ""]);
